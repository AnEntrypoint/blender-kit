...
`,
    ...
    '.vscode/settings.json': JSON.stringify({
      "python.pythonPath": "C:/Program Files/Blender Foundation/Blender 4.3/4.3/python/bin/python.exe",
...
Blender 4.3 project using [blender-kit](https://github.com/AnEntrypoint/blender-kit).

## Setup
\`\`\`bash
blender-dev download-engine  # shows download link for Blender 4.3
