...
triggers: [blender, bpy, blend, .py, .blend, 3d, render, blender-dev, blender-kit]
tools: [Bash, Read, Write, Edit]
---

# blender-dev — Blender 4.3 CLI

## Scaffold a new project
\`\`\`bash
bunx blender-kit <project-dir>     # scaffold boilerplate, installs CLAUDE.md + all configs
blender-dev download-engine        # show download info for Blender 4.3
...
blender-dev setup                  # install Python tools
